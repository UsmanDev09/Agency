...
export const home = [
  {
    ...
    title: "We will design a tailored release management strategy for you, aligning your development and operations teams to enable swift and dependable software releases.",
  },
  {
    icon: <TfiRulerPencil size={25} />,
    title: "Our team will guide you in migrating your applications to cloud environments effectively.",
  },
  {
    icon: <VscFileSubmodule size={25} />,
    title: "By leveraging Infrastructure as Code (IAC) and adhering to industry-leading practices, we'll oversee your cloud application deployments.",
  },
  {
    icon: <BiUser size={25} />,
    title: "We will develop a customized Continuous Integration/Continuous Deployment (CI/CD) pipeline to suit your specific requirements.",
  },
  {
    icon: <VscFileSubmodule size={25} />,
    title: "We will assist in transitioning your monolithic applications to a more efficient microservices architecture.",
  },
  {
    icon: <TfiRulerPencil size={25} />,
    title: "We will implement a robust system for monitoring, logging, and alerting, ensuring your applications perform at their best",
  },
  {
    icon: <AiOutlineCalendar size={25} />,
    title: "Our commitment extends to boosting the resilience, availability, scalability, and self-healing features of your applications",
  },
  {
    icon: <BiUser size={25} />,
    title: "We offer auditing and optimization services for your existing infrastructure.",
  },
  {
    icon: <VscFileSubmodule size={25} />,
    title: "We will implement security scanners within your application and its development pipelines",
  },
]
